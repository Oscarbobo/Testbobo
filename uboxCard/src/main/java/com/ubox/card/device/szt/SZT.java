package com.ubox.card.device.szt;
...
import com.htyd.szt.api.impl.HtydCarduBoxAPIImpl;
...
public class SZT extends Device{
	private static CardAPI szt;
	@Override
	public void init() {
		szt = new HtydCarduBoxAPIImpl();
	}
	...
	public ExtResponse cost(String json) {
        ...
        try {
        	//实例化嘟嘟宝实现类，
//        	CardAPI cardAPI = new BindService(CardService.service.getBaseContext());//toFix:初始化嘟嘟宝实现类
            ...
            Pay pay = szt.pay(orderNo, consume);
