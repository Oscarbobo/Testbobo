package com.ubox.card.device.ynylsf;
...
import com.ubox.card.device.ynylsf.compos.BusyPass;
import com.ubox.card.util.Utils;
import com.ubox.card.util.logger.Logger;

public class YNYLSF extends Device {
...
//            }
            ...
            String appNo = CardJson.appType+"";

            writeConsumeRecord(brushSeq, vmId, devNO, tradeData, cardNO, tradeTime, tradeFee, merchant, appNo); 
		} catch(Exception e) {
    ...
    private static void writeConsumeRecord(final String brushSeq,  final String vmId,   final String devNO,
                                           ...
                                           final String tradeFee,  final String merchant, final String appNO) {
