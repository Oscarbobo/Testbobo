...
import com.ubox.card.device.uboxs2.UBOXSER2.RESULT;
import com.ubox.card.util.logger.Logger;

public class UBOXS2 extends Device{
	
	private UBOXSER2 worker = new UBOXSER2();
...
//						return Converter.genCostRepJSON(rep, ext);
			...
			String tmp = UBOXSER2.int2string(Long.parseLong(rep.getOrderNo()),20);
			Logger.info("<<<<<<<<<<< tmp : "+tmp);
			...
			Map<String,Object> costMap =worker.cost(rep.getProduct().getSalePrice(),tmp,tmp1);
