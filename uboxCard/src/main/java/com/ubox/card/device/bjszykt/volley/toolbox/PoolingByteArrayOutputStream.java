...
public class PoolingByteArrayOutputStream extends ByteArrayOutputStream {
    ...
    private final com.ubox.card.device.bjszykt.volley.toolbox.ByteArrayPool mPool;
     ...
     */
    public PoolingByteArrayOutputStream(com.ubox.card.device.bjszykt.volley.toolbox.ByteArrayPool pool) {
     ...
     *        minimum size.
     */
    public PoolingByteArrayOutputStream(com.ubox.card.device.bjszykt.volley.toolbox.ByteArrayPool pool, int size) {
        mPool = pool;
