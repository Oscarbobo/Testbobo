package com.ubox.card.device.zjylsf.rs232;

import com.ubox.card.core.serial.RS232Worker;
import com.ubox.card.util.device.DeviceUtils;
import com.ubox.card.util.logger.Logger;

public class ZJYLSFSerial extends RS232Worker {
	
	public ZJYLSFSerial(int baudRate, int dataBits, int stopBits, int parity) {
